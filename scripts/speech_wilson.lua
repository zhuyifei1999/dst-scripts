return {
	...
	DESCRIBE =
	{
		...
		QUAGMIRE_CRABMEAT_COOKED = "I can put a good meal together in a pinch.",
		...
		--
		QUAGMIRE_RUBBLE_CARRIAGE = "It's on a road to nowhere.",
        QUAGMIRE_RUBBLE_CLOCK = "Someone beat that clock.",
        ...
        QUAGMIRE_GRILL_SMALL = "A baby barbecue.",
        ...
        QUAGMIRE_SLAUGHTERTOOL = "Laboratory tools for butchery.",
