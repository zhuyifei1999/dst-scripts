return {
	...
	DESCRIBE =
	{
		...
		MANDRAKE = "Mandrake roots have strange powers.",
		...
		TRINKET_1 = "Melted. Maybe the pyromaniac had some fun with them?",
		...
		TRINKET_20 = "The Viking keeps jumping out and hitting me with it??",
