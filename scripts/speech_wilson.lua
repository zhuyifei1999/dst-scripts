return {
	...
	DESCRIBE =
	{
		...
		RUINSHAT = "Does my hair look okay?",
		NIGHTMARE_TIMEPIECE =
		{
            CALM = "All is well.",
		...
		BACKPACK = "You could fit a whole lot of science equipment in there.",
		...
		TAFFY = "If I had a dentist they'd get mad at me for eating stuff like that.",
		...
		TRINKET_1 = "Melted. Did the arsonist have a go at these?",
		...
		TRINKET_10 = "They've quickly become the mime's favorite prop.",
		...
		TRINKET_15 = "The magician left his stuff out again.",
		TRINKET_16 = "The magician left his stuff out again.",
		TRINKET_17 = "A horrifying, failed utensil fusion. Maybe science *can* go too far.",
		TRINKET_18 = "I wonder what it's hiding?",
		TRINKET_19 = "It doesn't spin very well.",
		TRINKET_20 = "Why does the Viking keep jumping out and hitting me with it??",
		...
		GRASS_UMBRELLA = "My hair looks good wet... it's when it dries again that's the problem.",
