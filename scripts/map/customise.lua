...
local GROUP = {
	...
	["misc"] =		{
						...
						enable = true,
						items={
							["task_set"] = {value = "default", enable = false, spinner = nil, image = "world_map.tex", desc = map_descriptions, order = 1}, 
							["start_location"] = {value = "default", enable = false, spinner = nil, image = "world_start.tex", desc = start_descriptions, order = 2}, 
							["world_size"] = {value = "default", enable = false, spinner = nil, image = "world_size.tex", desc = size_descriptions, order = 3}, 
							["branching"] = {value = "default", enable = false, spinner = nil, image = "world_branching.tex", desc = branching_descriptions, order = 4}, 
							["loop"] = {value = "default", enable = false, spinner = nil, image = "world_loop.tex", desc = loop_descriptions, order = 5}, 
							["autumn"] = {value = "default", enable = true, spinner = nil, image = "autumn.tex", desc = season_length_descriptions, order = 6},
							["winter"] = {value = "default", enable = true, spinner = nil, image = "winter.tex", desc = season_length_descriptions, order = 7},
							["spring"] = {value = "default", enable = true, spinner = nil, image = "spring.tex", desc = season_length_descriptions, order = 8},
							["summer"] = {value = "default", enable = true, spinner = nil, image = "summer.tex", desc = season_length_descriptions, order = 9},
							["season_start"] = {value = "default", enable = false, spinner = nil, image = "season_start.tex", desc = season_start_descriptions, order = 10}, 
							["day"] = {value = "default", enable = false, spinner = nil, image = "day.tex", desc = day_descriptions, order = 11}, 
							-- ["cave_entrance"] = {value = "default", enable = false, spinner = nil, image = "caves.tex", desc = yesno_descriptions, order = 12},
							["weather"] = {value = "default", enable = false, spinner = nil, image = "rain.tex", desc = freqency_descriptions, order = 13}, 
							["lightning"] = {value = "default", enable = false, spinner = nil, image = "lightning.tex", desc = freqency_descriptions, order = 14}, 
							["frograin"] = {value = "default", enable = false, spinner = nil, image = "frog_rain.tex", desc = freqency_descriptions, order = 15}, 
							["wildfires"] = {value = "default", enable = false, spinner = nil, image = "smoke.tex", desc = freqency_descriptions, order = 16}, 
							["touchstone"] = {value = "default", enable = false, spinner = nil, image = "resurrection.tex", desc = freqency_descriptions, order = 17}, 
							["boons"] = {value = "default", enable = false, spinner = nil, image = "skeletons.tex", desc = freqency_descriptions, order = 18}, 
