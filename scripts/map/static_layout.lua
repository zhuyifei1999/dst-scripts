...
local function ConvertStaticLayoutToLayout(layoutsrc, additionalProps)
	...
	layout.ground_types = {
							...
							GROUND.OCEAN_COASTAL_SHORE,	GROUND.IMPASSABLE,			GROUND.IMPASSABLE,  GROUND.IMPASSABLE, 	    GROUND.UNDERROCK,	GROUND.MUD,					GROUND.QUAGMIRE_PEATFOREST,		GROUND.IMPASSABLE,
