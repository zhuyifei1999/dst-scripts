...
-- region.
local TrueScrollList = Class(Widget, function(self, context, create_widgets_fn, update_fn, scissor_x, scissor_y, scissor_width, scissor_height, scrollbar_offset)
	...
	self.scrollbar_height = scissor_height
	self:BuildScrollBar()
