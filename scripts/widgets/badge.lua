...
function Badge:StartWarning(r,g,b,a, force)
	if not self.warning.shown or force then
		self.warning:Show()
        if not (r and g and b and a) then -- default to red if no color is provided
            r = 1
            g = 0
            b = 0
            a = 1
