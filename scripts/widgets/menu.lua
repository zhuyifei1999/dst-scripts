...
function Menu:AddItem(text, cb, offset, style, size)
	local pos = Vector3(0,0,0)
	...
	elseif style and style == "long" then
	...
	if self.textSize then
		button:SetTextSize(size or self.textSize)
	else
		if JapaneseOnPS4() then
			button:SetTextSize(size or 40*0.8)
		else
			button:SetTextSize(size or 40)
		end
	end
