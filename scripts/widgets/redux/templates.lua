...
function TEMPLATES.DarkMenuBackground()
    return ReduxBackground("dark_left")
end

function TEMPLATES.CentreHighlightBackground()
    return ReduxBackground("centred")
end
...
function TEMPLATES.RankBadge()
    ...
    local festival_data = GetFestivalEventInfo()
    rank:SetFestivalBackground(festival_data and festival_data.EVENT_KEY or nil)
...
function TEMPLATES.WxpBar()
	...
	xp_next_title:SetPosition(190, -33)
	...
	wxpbar.nextlevelxp_text:SetPosition(190, -55)
