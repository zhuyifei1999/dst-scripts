...
local states =
{
    ...
    State{
        name = "arrive",
        tags = {"busy", "noattack", "nosleep", "swoop"},
    ...
    State{
        ...
        onenter = function(inst)
            if inst.components.combat and inst.components.combat.target then
                ...
                local offset = FindSwimmableOffset(pt, angle * DEGREES, 12, 8, true)
...
CommonStates.AddCombatStates(states,
{
    ...
    deathtimeline =
    {
        ...
        TimeEvent(4 * FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC001/creatures/bearger/groundpound") end),
    },
})
