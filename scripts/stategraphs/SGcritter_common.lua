    ...
    table.insert(states, State
    {
        ...
        onenter = function(inst, pushanim)
			...
			elseif inst.sg.mem.queuedplayfultarget ~= nil then
				...
				inst.sg:GoToState("playful_pre", inst.sg.mem.queuedplayfultarget)
...
SGCritterStates.AddPlayWithOtherCritter = function(states, events, timeline)
	table.insert(events, EventHandler("critterplayful", function(inst, data)
		...
		if inst:IsPlayful() and data.target:IsValid() 
	        ...
	        and not inst.sg:HasStateTag("playful") 
	        and data.target ~= nil then
	...
	table.insert(events, EventHandler("critterplaywithme", function(inst, data)
		if inst:IsPlayful() and data.target:IsValid() then
