...
function FightStat_GaveUp(attacker)
    --ThePlayer.components.overseer:GaveUp(attacker)
end
function FightStat_EndFight()
    --ThePlayer.components.overseer:EndFight()
end
function FightStat_Targeted(attacker)
    --ThePlayer.components.overseer:Targeted(attacker)
end
function FightStat_Attack(targ,weapon,projectile,damage)
    --ThePlayer.components.overseer:Attack(targ,weapon,projectile,damage)
end
function FightStat_AttackByFollower(targ,weapon,projectile,damage)
    --ThePlayer.components.overseer:AttackByFollower(targ,weapon,projectile,damage)
end
function FightStat_Equip(item,slot)
    --ThePlayer.components.overseer:Equip(item,slot)
end
function FightStat_TrapSprung(trap,target,damage)
    --ThePlayer.components.overseer:TrapSprung(trap,target,damage)
end
function FightStat_Heal(amount)
    --ThePlayer.components.overseer:Heal(amount)
end
function FightStat_AttackedBy(attacker,damage,absorbed)
    --ThePlayer.components.overseer:AttackedBy(attacker,damage,absorbed)
end
function FightStat_AddKill(targ,damage,weapon)
    --ThePlayer.components.overseer:AddKill(targ,damage,weapon)
end
function FightStat_AddKillByFollower(targ,damage,weapon)
    --ThePlayer.components.overseer:AddKillByFollower(targ,damage,weapon)
end
function FightStat_AddKillByMine(targ,damage)
    --ThePlayer.components.overseer:AddKillByMine(targ,damage)
end
function FightStat_Caught(attacker)
    --ThePlayer.components.overseer:Caught(attacker)
end
function FightStat_BrokenArmor(prefab)
    --ThePlayer.components.overseer:BrokenArmor(prefab)
end
function FightStat_Absorb(amount)
    --ThePlayer.components.overseer:Absorb(amount)
end
