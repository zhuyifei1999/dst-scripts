...
Recipe("anchor", 		       {Ingredient("boards", 2), 		Ingredient("rope", 3), Ingredient("cutstone", 3)}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO, "anchor_item_placer")
...
Recipe("steeringwheel",        {Ingredient("boards", 2), 		Ingredient("rope", 1)}, RECIPETABS.SEAFARING, TECH.SEAFARING_TWO, "steeringwheel_item_placer")
