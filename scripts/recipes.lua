...
Recipe2("hermithotspring_constr",						{},																							TECH.LOST,					{nounlock = true, placer="hermithotspring_constr_placer", hint_msg="NEEDSHERMITCRABHELP_CRAFTING", image="hermithotspring.tex", always_allow_buffered_placer=true, station_tag="hermitcrab", testfn=IsHotSpringWithinPearlArea, min_spacing=5.3})
