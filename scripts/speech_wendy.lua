return {
	...
	DESCRIBE =
	{
		...
		LAVAE_EGG = 
		{
			GENERIC = "Is it even worth it to put stake in your future?",
		},
		LAVAE_EGG_CRACKED =
		{
		...
		DUG_BERRYBUSH = "Let's go back to my house.",
		...
		GOLDENPITCHFORK = "One might as well till the earth with style.",
		...
		STRAWHAT = "When the sun beats mercilessly, life finds a way.",
        ...
        TRINKET_15 = "Winning with only one piece is hopeless.",
        TRINKET_16 = "Winning with only one piece is hopeless.",
        TRINKET_17 = "Two utensils that are one. It reminds me of myself and Abigail.",
