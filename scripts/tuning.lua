...
--[[
      ...
      --  PIRATE_SPAWN_DELAY = {min=day_time/2, max=20*day_time}, --{min=30, max=180},
		...
		WAGBOSS_BEAM_LUNAR_BURN_DPS = 65, --DOT
		...
		ALTERGUARDIAN_PHASE4_LUNARRIFT_HEALTH = 18000,
		ALTERGUARDIAN_PHASE4_LUNARRIFT_WALKSPEED = 2.9,
		ALTERGUARDIAN_PHASE4_LUNARRIFT_ATTACK_PERIOD = 4,
		...
		ALTERGUARDIAN_LUNAR_FISSURE_LUNAR_BURN_DPS = 50, --DOT
		ALTERGUARDIAN_LUNAR_SUPERNOVA_PLANAR_DAMAGE = 50, --initial hit
		ALTERGUARDIAN_LUNAR_SUPERNOVA_LUNAR_BURN_DPS = 80, --DOT

		ALTERGUARDIAN_PHASE4_SUPERNOVA_CD = 45,
        ...
        GESTALT_EVOLVED_EXPLODE_CHANCE = 0.1,
		GESTALT_EVOLVED_MAX_DISTSQ_RELOCATE = 14*14,
