...
--[[
      ...
      --  PIRATE_SPAWN_DELAY = {min=day_time/2, max=20*day_time}, --{min=30, max=180},
        ...
        LUNARHAIL_BUILDUP_DECAY_RATE = 0.5 / seg_time, -- Percent per second.
        ...
        LUNARHAIL_BUILDUP_TOTAL_WORK_AMOUNT_LARGE = 5,
        LUNARHAIL_BUILDUP_MOONGLASS_AMOUNT_LARGE = 3,

        LUNARHAIL_BUILDUP_MOONGLASS_REWARDS_CHARGED_CHANCE = 0.25,
        ...
        BIRD_CORPSE_FADE_MIN_TIME = 5,
        BIRD_CORPSE_FADE_MAX_TIME = 8,
