...
--fallback to speech_wilson.lua 		DEVTOOL_NODEV = "I'm not strong enough to wield it.",
        ...
        ROTTENEGG =
        {
			...
			CAN_PROCESS = "MY SUPERIOR CIRCUITRY WILL PROCESS THIS FAILED CHILD TO NUTRIENTS", -- TODO
        },
        ...
        SPOILED_FOOD =
        {
            ...
            CAN_PROCESS = "NOW IT CAN BE PROCESSED", -- TODO
        },
        STAGEHAND =
        {
...
--fallback to speech_wilson.lua             MISSINGSKILL = "only_used_by_winona",
		...
		SPOILED_FISH =
        {
			...
			CAN_PROCESS = "WORRY NOT ORGANICS. I CAN PROCESS THIS INTO NUTRIENTS", -- TODO
        },
