return {
	...
	ACTIONFAIL_GENERIC = "ERROR: ACTION NOT AVAILABLE",
	...
	DESCRIBE =
	{
		...
		WILSON = 
		{
			GENERIC = "DETECTING... WILSON!",
			ATTACKER = "THAT WILSON IS NOT TO BE TRUSTED.",
			MURDERER = "KILL! KILL!",
			REVIVER = "THAT WILSON IS AN ASSET TO OUR SURVIVAL.",
			GHOST = "FLESH WEAKLING WILSON NEEDS A HEART.",
		},
		WOLFGANG = 
		{
			GENERIC = "DETECTING... WOLFGANG!",
			ATTACKER = "THAT WOLFGANG IS NOT TO BE TRUSTED.",
			MURDERER = "KILL! KILL!",
			REVIVER = "THAT WOLFGANG IS AN ASSET TO OUR SURVIVAL.",
			GHOST = "FLESH WEAKLING WOLFGANG NEEDS A HEART.",
		},
		WAXWELL = 
		{
			GENERIC = "DETECTING... MAXWELL!",
			ATTACKER = "THAT MAXWELL IS NOT TO BE TRUSTED.",
			MURDERER = "KILL! KILL!",
			REVIVER = "THAT MAXWELL IS AN ASSET TO OUR SURVIVAL.",
			GHOST = "FLESH WEAKLING MAXWELL NEEDS A HEART.",
		},
		WX78 = 
		{
			GENERIC = "DETECTING... OTHER WX-78!",
			ATTACKER = "THAT WX-78 IS NOT TO BE TRUSTED.",
			MURDERER = "KILL! KILL!",
			REVIVER = "THAT OTHER WX-78 IS AN ASSET TO OUR SURVIVAL.",
			GHOST = "INFERIOR WX-78 NEEDS A HEART.",
		},
		WILLOW = 
		{
			GENERIC = "DETECTING... WILLOW!",
			ATTACKER = "THAT WILLOW IS NOT TO BE TRUSTED.",
			MURDERER = "KILL! KILL!",
			REVIVER = "THAT WILLOW IS AN ASSET TO OUR SURVIVAL.",
			GHOST = "FLESH WEAKLING WILLOW NEEDS A HEART.",
		},
		WENDY = 
		{
			GENERIC = "DETECTING... WENDY!",
			ATTACKER = "THAT WENDY IS NOT TO BE TRUSTED.",
			MURDERER = "KILL! KILL!",
			REVIVER = "THAT WENDY IS AN ASSET TO OUR SURVIVAL.",
			GHOST = "FLESH WEAKLING WENDY NEEDS A HEART.",
		},
		WOODIE = 
		{
			GENERIC = "DETECTING... WOODIE!",
			ATTACKER = "THAT WOODIE IS NOT TO BE TRUSTED.",
			MURDERER = "KILL! KILL!",
			REVIVER = "THAT WOODIE IS AN ASSET TO OUR SURVIVAL.",
			GHOST = "FLESH WEAKLING WOODIE NEEDS A HEART.",
		},
		WICKERBOTTOM = 
		{
			GENERIC = "DETECTING... WICKERBOTTOM!",
			ATTACKER = "THAT WICKERBOTTOM IS NOT TO BE TRUSTED.",
			MURDERER = "KILL! KILL!",
			REVIVER = "THAT WICKERBOTTOM IS AN ASSET TO OUR SURVIVAL.",
			GHOST = "FLESH WEAKLING WICKERBOTTOM NEEDS A HEART.",
		},
		WES = 
		{
			GENERIC = "DETECTING... WES!",
			ATTACKER = "THAT WES IS NOT TO BE TRUSTED.",
			MURDERER = "KILL! KILL!",
			REVIVER = "THAT WES IS AN ASSET TO OUR SURVIVAL.",
			GHOST = "FLESH WEAKLING WES NEEDS A HEART.",
		},
		...
		MUSHTREE_TALL={
            GENERIC = "IT IS USEFULLY BRIGHT",
            BLOOM = "IT IS REPLICATING",
        },
		MUSHTREE_MEDIUM={
            GENERIC = "SHINY RED",
		...
		MUSHTREE_SMALL={
            GENERIC = "SHINY GREEN",
            BLOOM = "IT KEEPS PRODUCING POWER AND FLUFF",
        },
        ...
        {
            GENERIC = "ERROR: DON'T WANT TO",
            OPEN = "SOLAR ARRAY NEED REFUELING.",
		...
		MANDRAKE = "I HAVE KILLED IT. GOOD.",
        ...
        SADDLE_WAR = "I SHALL DOMINATE ALL CREATURES",
        SADDLEHORN = "HAHA, IT SHALL BE NAKED",
        BRUSH = "I WILL REMOVE YOUR HAIR, BIT BY BIT",
		SANITYROCK =
		{
		...
		STEELWOOL = "METALLIC ORGANIC FIBER. DOES NOT COMPUTE.",
		...
		TRINKET_13 = "USELESS JUNK FROM A BYGONE AGE",
		...
		TRINKET_14 = "USELESS JUNK FROM A BYGONE AGE",
        TRINKET_15 = "USELESS JUNK FROM A BYGONE AGE",
        TRINKET_16 = "USELESS JUNK FROM A BYGONE AGE",
        TRINKET_17 = "USELESS JUNK FROM A BYGONE AGE",
        TRINKET_18 = "USELESS JUNK FROM A BYGONE AGE",
        TRINKET_19 = "USELESS JUNK FROM A BYGONE AGE",
        TRINKET_20 = "USELESS JUNK FROM A BYGONE AGE",
        TRINKET_21 = "USELESS JUNK FROM A BYGONE AGE",
        TRINKET_22 = "USELESS JUNK FROM A BYGONE AGE",
        TRINKET_23 = "USELESS JUNK FROM A BYGONE AGE",
        TRINKET_24 = "USELESS JUNK FROM A BYGONE AGE",
        TRINKET_25 = "USELESS JUNK FROM A BYGONE AGE",
		TRINKET_26 = "USEFUL JUNK FROM A BYGONE AGE",
		TRINKET_27 = "USELESS JUNK FROM A BYGONE AGE",
		...
		WALL_MOONROCK_ITEM = "I CAN BUILD A MOON BASE?",
        ...
        REVIVER = "IT UNDOES MY MEATLING DESTRUCTION",
	...
	DESCRIBE_SAMECHARACTER = "THEY LOOK MUCH MORE INTELLIGENT THAN THE OTHERS",
	EAT_FOOD =
	{
