...
-----------------------------------------------------------------------------------------------------------------
	...
	scripts["ARTIFICER_SOLILOQUY"]= {
		...
		lines = {
			...
			{roles = {"BIRD2"},				duration = 1.5,		line = STRINGS.STAGEACTOR.ARTIFICER_SOLILOQUY[2]},
			...
			{roles = {"ARTIFICER"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.ARTIFICER_SOLILOQUY[6]},
			{roles = {"ARTIFICER"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.ARTIFICER_SOLILOQUY[7]},
			{roles = {"ARTIFICER"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.ARTIFICER_SOLILOQUY[8]},
			{roles = {"ARTIFICER"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.ARTIFICER_SOLILOQUY[9]},
			{roles = {"ARTIFICER"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.ARTIFICER_SOLILOQUY[10]},
			{roles = {"ARTIFICER"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.ARTIFICER_SOLILOQUY[11]},
			{roles = {"ARTIFICER"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.ARTIFICER_SOLILOQUY[12]},
			{roles = {"ARTIFICER"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.ARTIFICER_SOLILOQUY[13]},
			{roles = {"ARTIFICER"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.ARTIFICER_SOLILOQUY[14]},
			{roles = {"ARTIFICER"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.ARTIFICER_SOLILOQUY[15]},
			{roles = {"ARTIFICER"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.ARTIFICER_SOLILOQUY[16]},

            {roles = {"BIRD1"},				duration = 1.5,		line = STRINGS.STAGEACTOR.ARTIFICER_SOLILOQUY[17]},
			{roles = {"BIRD2"},				duration = 1.5,		line = STRINGS.STAGEACTOR.ARTIFICER_SOLILOQUY[18]},
	...
	scripts["VISIONIST_SOLILOQUY"]= {
		...
		lines = {
			...
			{roles = {"BIRD2"},				duration = 1.5,		line = STRINGS.STAGEACTOR.VISIONIST_SOLILOQUY[2]},
			{roles = {"BIRD1", "BIRD2"},    duration = 1.5,		line = STRINGS.STAGEACTOR.VISIONIST_SOLILOQUY[3]},

			{roles = {"VISIONIST"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.VISIONIST_SOLILOQUY[4]},
			{roles = {"VISIONIST"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.VISIONIST_SOLILOQUY[5]},
			{roles = {"VISIONIST"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.VISIONIST_SOLILOQUY[6]},
			{roles = {"VISIONIST"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.VISIONIST_SOLILOQUY[7]},
			{roles = {"VISIONIST"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.VISIONIST_SOLILOQUY[8]},
			{roles = {"VISIONIST"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.VISIONIST_SOLILOQUY[9]},
			{roles = {"VISIONIST"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.VISIONIST_SOLILOQUY[10]},
			{roles = {"VISIONIST"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.VISIONIST_SOLILOQUY[11]},
			{roles = {"VISIONIST"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.VISIONIST_SOLILOQUY[12]},
			{roles = {"VISIONIST"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.VISIONIST_SOLILOQUY[13]},

            {roles = {"BIRD1"},				duration = 1.5,		line = STRINGS.STAGEACTOR.VISIONIST_SOLILOQUY[14]},
			{roles = {"BIRD2"},				duration = 1.5,		line = STRINGS.STAGEACTOR.VISIONIST_SOLILOQUY[15]},
	...
	scripts["ELYTRA_SOLILOQUY"]= {
		...
		lines = {
			...
			{roles = {"BIRD2"},				duration = 1.5,		line = STRINGS.STAGEACTOR.ELYTRA_SOLILOQUY[2]},
			...
			{roles = {"ELYTRA"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.ELYTRA_SOLILOQUY[5]},
			{roles = {"ELYTRA"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.ELYTRA_SOLILOQUY[6]},
			{roles = {"ELYTRA"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.ELYTRA_SOLILOQUY[7]},
			{roles = {"ELYTRA"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.ELYTRA_SOLILOQUY[8]},
			{roles = {"ELYTRA"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.ELYTRA_SOLILOQUY[9], do_idle_for_line = true},
			{roles = {"ELYTRA"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.ELYTRA_SOLILOQUY[10]},
			{roles = {"ELYTRA"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.ELYTRA_SOLILOQUY[11]},
			{roles = {"ELYTRA"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.ELYTRA_SOLILOQUY[12]},
			{roles = {"ELYTRA"},		duration = 2.5, 	line = STRINGS.STAGEACTOR.ELYTRA_SOLILOQUY[13]},

            {roles = {"BIRD1"},				duration = 1.5,		line = STRINGS.STAGEACTOR.ELYTRA_SOLILOQUY[14]},
			{roles = {"BIRD2"},				duration = 1.5,		line = STRINGS.STAGEACTOR.ELYTRA_SOLILOQUY[15]},
...
local MARIONETTE_TIME = 1.1
	...
	scripts["THEVAULT"]= {
		...
		lines = {
			...
			{actionfn = fn.startbgmusic,	duration = 0.2,		musictype = "confession"}, --bgm_mood: dontstarve/music/music_FE_cavepuzzle
			...
			{roles = {"BIRD1"}, duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.BIRD1_3},

			--

			{roles = {"ARTIFICER"},			duration = 3.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE1_ARTIFICER },
			{roles = {"ARTIFICER"},			duration = 1.5,		line = STRINGS.STAGEACTOR.THEVAULT.LINE2_ARTIFICER },
			{roles = {"ARTIFICER"},			duration = 1.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE3_ARTIFICER },
			...
			{roles = {"VISIONIST"},			duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE6_VISIONIST, anim = "emote_swoon" },
			{roles = {"VISIONIST"},			duration = 2.5,		line = STRINGS.STAGEACTOR.THEVAULT.LINE7_VISIONIST, anim = "emoteXL_kiss" },

			{roles = {"ELYTRA"},			duration = 2.5,		line = STRINGS.STAGEACTOR.THEVAULT.LINE8_ELYTRA },
			{roles = {"ELYTRA"},			duration = 3.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE9_ELYTRA },
			{roles = {"ELYTRA"},			duration = 1.5,		line = STRINGS.STAGEACTOR.THEVAULT.LINE10_ELYTRA },
			{roles = {"ELYTRA"},			duration = 1.5,		line = STRINGS.STAGEACTOR.THEVAULT.LINE11_ELYTRA },
			{roles = {"ELYTRA"},			duration = 2.5,		line = STRINGS.STAGEACTOR.THEVAULT.LINE12_ELYTRA },

			{roles = {"VISIONIST"},			duration = 2.5,		line = STRINGS.STAGEACTOR.THEVAULT.LINE13_VISIONIST },
			{roles = {"VISIONIST"},			duration = 2.5,		line = STRINGS.STAGEACTOR.THEVAULT.LINE14_VISIONIST },
			{roles = {"VISIONIST"},			duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE15_VISIONIST },
			{roles = {"VISIONIST"},			duration = 3.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE16_VISIONIST, anim = "emote_swoon" },

			{roles = {"ARTIFICER"},			duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE17_ARTIFICER, anim = "emoteXL_facepalm" },

			{roles = {"ELYTRA"},			duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE18_ELYTRA, do_idle_for_line = true },

			{roles = {"VISIONIST"},			duration = 2.5,		line = STRINGS.STAGEACTOR.THEVAULT.LINE19_VISIONIST, anim = "emote_shrug" },

			{roles = {"ELYTRA"},			duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE20_ELYTRA },
			{roles = {"ELYTRA"},			duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE21_ELYTRA, anim = {"bow_pre","bow_pst"} },
			...
			{roles = {"ARTIFICER"},			duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE24_ARTIFICER, anim = "emote_impatient" },

			{roles = {"ELYTRA"},			duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE25_ELYTRA },
			{roles = {"ELYTRA"},			duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE26_ELYTRA },
			...
			{roles = {"ELYTRA"},			duration = 2.5,		line = STRINGS.STAGEACTOR.THEVAULT.LINE34_ELYTRA, anim={"emote_pre_toast_chalice", "emote_loop_toast_chalice", "emote_loop_toast_chalice"} },
			{roles = {"ELYTRA"},			duration = 2.5,		line = STRINGS.STAGEACTOR.THEVAULT.LINE35_ELYTRA, anim = "emote_loop_toast_chalice" },

			{roles = {"VISIONIST"},			duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE36_VISIONIST },
			{roles = {"VISIONIST"},			duration = 2.5,		line = STRINGS.STAGEACTOR.THEVAULT.LINE37_VISIONIST, anim={"emote_pre_toast_chalice", "emote_loop_toast_chalice"} },

			{roles = {"VISIONIST"},			duration = 0.1,	},

			{actionfn = fn.override_with_chalice, nopause = true },
			{roles = {"VISIONIST"},			duration = 2.0,		anim = {"drink_pre", "drink" },
				castsound = {
			...
			{roles = {"VISIONIST"},			duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE38_VISIONIST, anim = "emoteXL_annoyed" },
			{roles = {"VISIONIST"},			duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE39_VISIONIST, anim = "idle_groggy" },
			{roles = {"VISIONIST"},			duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE40_VISIONIST, anim = { "emote_pre_sit2", "emote_loop_sit2" }, endidleanim = "emote_loop_sit2" },
			...
			{roles = {"ARTIFICER"},			duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE43_ARTIFICER, anim = "emoteXL_angry" },

			{actionfn = fn.findpositions,	duration = 1.0,		positions={["ELYTRA"] = 3}},
			...
			{roles = {"ELYTRA"},			duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE60_ELYTRA,  },
			{roles = {"ELYTRA"},			duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE61_ELYTRA,  },
			{roles = {"ELYTRA"},			duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE62_ELYTRA,  },
			{roles = {"ELYTRA"},			duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE63_ELYTRA,  },
			{roles = {"ELYTRA"},			duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE64_ELYTRA,  },
			{roles = {"ELYTRA"},			duration = 2.0,		line = STRINGS.STAGEACTOR.THEVAULT.LINE65_ELYTRA, anim = { "emote_pre_sit2", "emote_loop_sit2" }, endidleanim = "emote_loop_sit2" },

			{actionfn = fn.enableblackout,		duration = 2, },
			...
			{actionfn = fn.findpositions,	duration = 1,		positions={["ARTIFICER"] = 3,["VISIONIST"] = 2,["ELYTRA"] = 1,}},
