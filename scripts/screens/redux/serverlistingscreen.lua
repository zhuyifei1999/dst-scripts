...
function ServerListingScreen:Join(warnedOffline, warnedLanguage)
    if self.selected_server ~= nil then
        ...
        elseif not warnedLanguage and self.view_online and self.event_id == "" and self.selected_server.tags:split(",")[1] ~= STRINGS.PRETRANSLATED.LANGUAGES[GetLanguage()]:lower() then
