...
function ServerListingScreen:IsValidWithFilters(server)
    ...
    for i, v in ipairs(self.filters) do
        ...
        if v.spinner ~= nil then
            ...
            or (v.name == "EVENT" and server.event ~= v.spinner:GetSelectedData() and v.spinner:GetSelectedData() ~= "ANY")
...
function ServerListingScreen:MakeFiltersPanel(filter_data)
    ...
    table.insert(self.filters, CreateSpinnerFilter( self, "EVENT", STRINGS.UI.SERVERLISTINGSCREEN.EVENT, any_on_off, false ))
