...
function BroadcastingLoginScreen:DoInit()
	...
	self.edit_username_bg:SetTexture( "images/textboxes.xml", "textbox_long.tex" )
	...
	self.edit_password_bg:SetTexture( "images/textboxes.xml", "textbox_long.tex" )
	...
	self.edit_username:SetFocusedImage( self.edit_username_bg, "images/textboxes.xml", "textbox_long_over.tex", "textbox_long.tex" )
	...
	self.edit_password:SetFocusedImage( self.edit_password_bg, "images/textboxes.xml", "textbox_long_over.tex", "textbox_long.tex" )
