...
local assets =
{
	Asset("DYNAMIC_ANIM", "anim/dynamic/swap_backpack_hound.zip"),
...
local ui_preview =
{
	build = "swap_backpack_hound",
	bank = "swap_backpack_hound",
}

return CreatePrefabSkin("backpack_hound",
{
	...
	assets = assets,
	tags = tags,
	build_name = "swap_backpack_hound",
	rarity = "Elegant",
})