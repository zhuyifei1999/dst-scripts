...
-- fire neettles
--  harvest item: foliage(90%), burning nettles (10%) 
--  pros: harvest to make nettle tea which make the player burning hot for a very short time
--  cons: if left to bloom, it will have a spore clould that is an AOE DOT
...
local function UpdateResearchStage(inst, stage)
	if stage == 2 and inst.mature then	-- stage 3 + mature = picked state
