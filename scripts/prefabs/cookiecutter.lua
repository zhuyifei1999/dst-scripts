...
--[[local function SetAttackOnCooldown(inst)
	inst.attack_on_cooldown = true
	inst:DoTaskInTime(resetattackcooldown)
end]]

--[[local function resetattackcooldown(inst)
	inst.attack_on_cooldown = false
end]]

--[[local function OnChildGoingHome(inst)
