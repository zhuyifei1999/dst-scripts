...
local assets =
{
	Asset("DYNAMIC_ANIM", "anim/dynamic/swap_backpack_bearger.zip"),
...
local ui_preview =
{
	build = "swap_backpack_bearger",
	bank = "swap_backpack_bearger",
}

return CreatePrefabSkin("backpack_bearger_loyal",
{
	...
	assets = assets,
	tags = tags,
	build_name = "swap_backpack_bearger",
	rarity = "Loyal",
