...
local function fn(data, build, swap_build, fuel_value, is_wooden)
...
local function driftwood_oar()
    return fn(TUNING.BOAT.OARS.DRIFTWOOD, "oar_driftwood", "swap_oar_driftwood", TUNING.MED_FUEL, true)
end
