...
local function MakeTarget(name, colour)
...
return Prefab("reticuleaoe", fn, assets),
    Prefab("reticuleaoeping", pingfn, assets),
    MakeTarget("reticuleaoehostiletarget", { 1, .25, 0, 1 }),
    MakeTarget("reticuleaoefriendlytarget", { 0, 1, .25, 1 }),
    MakeTarget("reticuleaoecctarget", { .3, .5, .2, 1 })
