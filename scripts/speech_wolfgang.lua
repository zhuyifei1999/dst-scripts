return {
	ACTIONFAIL =
	{
    	...
    	CHANGEIN =
        {
            ...
            INUSE = "Wolfgang will wait til %s leaves to change. He is shy.",
        },
    	ATTUNE =
        {
	...
	DESCRIBE =
	{
        ...
        TRINKET_22 = "Will take to fragile man. He always talk about \"pulling strings\".",
        TRINKET_23 = "Wolfgang does not know which end to blow.",
        TRINKET_24 = "Kitty has nice round tum.",
