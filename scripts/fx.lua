...
----------------------------------------------------------
    ...
    {
        name = "abigail_gravestone_rebirth_fx",
        bank = "ghost",
        build = "ghost_abigail_build",
        anim = "wendy_resurrect",
        fn = FinalOffsetNegative2,
    },

    {
        name = "wendy_gravestone_rebirth_fx",
        bank = "ghost",
        build = "ghost_wendy_build",
        build_is_skin = true,
        anim = "wendy_ghost_resurrect",
        fn = FinalOffsetNegative1,
    },    
}
