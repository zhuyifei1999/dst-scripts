...
function PeriodicThreat:PlayWarnSound(key)
	--KAJ: TODO this shound should probably only be played for the player(s) it affects?
...
function PeriodicThreat:GetSpawnPoint(key)
    -- KAJ: TODO: MP_LOGIC Need to figure out exact context. The thread possibly needs a target player, or use nearest player. Seems only worm uses it and thus caves
	local player = ThePlayer
