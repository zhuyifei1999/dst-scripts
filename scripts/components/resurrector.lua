...
function Resurrector:OnBuilt(builder)
    -- no longer require it to be active for the penalty to apply
    if SaveGameIndex:CanUseExternalResurector() and (self.used == nil or self.used == false) then--and self.active == true then
